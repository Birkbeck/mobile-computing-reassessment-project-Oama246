...
public final class ItemMovieBinding implements ViewBinding {
  ...
  private ItemMovieBinding(@NonNull LinearLayout rootView, @NonNull TextView movieCategory,
  ...
  public static ItemMovieBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.movieCategory;
      TextView movieCategory = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemMovieBinding((LinearLayout) rootView, movieCategory, movieTitle);
    }
